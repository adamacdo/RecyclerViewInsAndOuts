...
public class StandardRecyclerViewFragment extends BaseFragment implements
    ...
    public static StandardRecyclerViewFragment newInstance() {
        Bundle args = new Bundle();

        StandardRecyclerViewFragment fragment = new StandardRecyclerViewFragment();
